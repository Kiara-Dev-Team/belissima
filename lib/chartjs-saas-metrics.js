    ...
    new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                ...
                subtitle: {
                    display: true,
                    text: 'Ratios: Enterprise ' + ratios[0] + ':1, Mid-Market ' + ratios[1] + ':1, SMB ' + ratios[2] + ':1, Startup ' + ratios[3] + ':1',
                    font: { size: 11 },
                    color: '#6b7280'
                }
            }
    ...
    new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'Gross Revenue Retention Progress',
                    font: { size: 14 }
                },
                subtitle: {
                    display: true,
                    text: 'Healthy Range: 85-90% (Benchmark: 88%)',
                    font: { size: 11 },
                    color: '#6b7280'
                }
            }
