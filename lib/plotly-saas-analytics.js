...
// 7. ARR Trend with Range Slider - Financial Authority Palette
function createARRTrendChart(divId) {
    const months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
    const arr = [8.2, 8.6, 9.1, 9.5, 9.9, 10.3, 10.8, 11.2, 11.7, 12.0, 12.2, 12.4];
